...
const Expenses = ({ expensesHistory, setExpensesHistory }) => {
    ...
    const handleSubmit = (e) => {
        ...
        localStorage.setItem('expensesData', formDataText);
        setExpensesHistory([...expensesHistory, formData]);
        setFormData({
            amount: '',
            currency: '',
            category: '',
        ...
        <section className="background">
            <div className="container header_container">
                <header className="header">
                    ...
                    <h1 className="header_item">Expenses</h1>
                </header>
